...
// busco el usuario
    /* $SQL1="";
      //$SQL1="select * from pedido where realizadopor2 like '".$xxxnombre."%' and  idpedido='".$Columna->idpedido."'";
      $SQL1="select * from pedido where realizadopor2 in (select idusuarios_estado from usuarios_estado where id_usuarios = '".$xxxiduser."' ) and  idpedido='".$Columna->idpedido."'";
      $db->setQuery($SQL1);

...
//HH: Botones de navegacion Operador     
    ...
    public function buscar_Campana_primero() {
        $query = $this->db->query("SELECT * FROM marqueting_analisis order by id_mar asc LIMIT 0,1");
        if ($query->num_rows() === 1) {
            return $query->result();
        } else {
            return false;
    ...
    public function buscar_Campana_siguiente($codigo_actual) {
        $query = $this->db->query("SELECT * FROM marqueting_analisis WHERE id_mar > '" . $codigo_actual . "' order by id_mar asc  LIMIT 0,1");
        if ($query->num_rows() === 1) {
            return $query->result();
        } else {
            return false;
    ...
    public function buscar_Campana_ultimo() {
        $query = $this->db->query("SELECT * FROM marqueting_analisis order by id_mar desc LIMIT 0,1");
        if ($query->num_rows() === 1) {
            return $query->result();
        } else {
            return false;
    ...
    public function buscar_Campana_anterior($codigo_actual) {
        $query = $this->db->query("SELECT * FROM marqueting_analisis WHERE id_mar < '" . $codigo_actual . "' order by id_mar desc  LIMIT 0,1");
        if ($query->num_rows() === 1) {
            return $query->result();
        } else {
            return false;
    ...
    public function buscar_Campana_codigo($codigo_actual) {
        $query = $this->db->query("SELECT * FROM marqueting_analisis where id_mar = '" . $codigo_actual . "' LIMIT 0,1");
        if ($query->num_rows() === 1) {
            return $query->result();
        } else {
            return false;
